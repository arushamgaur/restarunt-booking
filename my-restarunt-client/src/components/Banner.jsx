...
const Banner = () => {
  return (
    <div className='max-w-screen-2xl section-container mx-auto xl:px24 bg-gradient-to-r from-[#FAFAFA] from-0% to-[#FAFAFA] to-500%'>
        <div className='py-24 flex flex-col md:flex-row-reverse justify-between items-center gap-8'>
                ...
                <div className='flex flex-col md:flex-row
                 items-center justify-around -mt-14 gap-4'>
            ...
            <div className='md:w-1/2 space-y-7 px-4'>
                <h2 className='md:text-5xl text-4xl font-bold md:leading-snug leading-snug text-[#000]'>Dive Into Delights Of Delectables <span className='text-green'>Food</span></h2>
